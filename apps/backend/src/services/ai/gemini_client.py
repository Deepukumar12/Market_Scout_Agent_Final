...
class GeminiClient:
    ...
    async def generate_competitor_intel(
        ...
        system_prompt = (
            ...
            "the Sentinel Pro SaaS platform. You MUST return ONLY valid JSON and nothing else."
        )
...
"""
    ...
    async def generate_scan_report(
        ...
        instructions = """
You are the Sentinel Pro analysis step. You MUST return ONLY valid JSON matching the given schema.
