...
from src.core.logging_config import setup_logging, LogColors
setup_logging()
logger = logging.getLogger("src.main")

from src.core.database import db
from src.api.router import api_router
from src.domains.auth.controllers.auth_controller import router as auth_router
from src.domains.telemetry.controllers.telemetry_controller import router as telemetry_router
...
async def lifespan(app: FastAPI):
    ...
    from src.scheduler.scheduler_service import start_scheduler as start_old_scheduler
    from src.scheduler.scheduler import init_scheduler, stop_scheduler as stop_daily_scheduler
    ...
    from src.scheduler.scheduler_service import stop_scheduler
    stop_scheduler()
