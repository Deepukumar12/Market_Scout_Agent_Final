...
from src.domains.reports.controllers.reports import router as reports_router
...
from src.domains.reports.controllers.reports_v2 import router as reports_v2_router # New Reports API
