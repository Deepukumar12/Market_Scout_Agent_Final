...
from src.domains.intelligence.services.delta_engine import FREQUENCY_DEFAULT_HOURS
...
async def scan_competitor(
    ...
    try:
        ...
        if result:
            ...
            from src.domains.intelligence.services.delta_engine import store_new_features
