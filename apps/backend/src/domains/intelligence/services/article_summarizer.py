...
from src.domains.ai.services.llm_gateway import generate_text_sync
from src.domains.ai.services.token_guard import estimate_tokens, truncate_to_token_limit
...
"""
    ...
    try:
        out = generate_text_sync(prompt, system=sys_text, max_tokens=350)
        return out or ""
...
"""
    ...
    try:
        raw_output = generate_text_sync(prompt, system=sys_text, max_tokens=len(articles_with_urls) * 350)
