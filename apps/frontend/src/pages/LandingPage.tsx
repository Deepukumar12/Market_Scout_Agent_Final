        ...
        <div className={cn(
          ...
          <div className="flex items-center gap-12">
            <Link to="/" className="flex items-center gap-3 group">
              ...
              <span className="text-2xl font-black tracking-tighter uppercase italic">SENTRY<span className="text-blue-600">IQ</span></span>
            </Link>
        ...
        <div className="max-w-7xl mx-auto px-8 relative z-10 grid lg:grid-cols-2 gap-32 items-center">
          <div className="space-y-12">
            ...
            <p className="text-xl md:text-2xl text-[#86868B] font-medium leading-relaxed max-w-xl">
              Sentry IQ doesn't just collect data; it decodes technical momentum. Our RAG-driven pipeline identifies shifts that traditional monitoring systems miss.
            </p>
        ...
        <div className="max-w-4xl mx-auto space-y-20">
          ...
          <div className="space-y-4">
             {[
               ...
               { q: "Can we track custom competitors?", a: "Yes. The Sentry IQ platform allows for ad-hoc addition of any corporate entity with a technical presence for real-time tracking." },
