...
export function Footer() {
  ...
  const footerSections = [
    ...
    },
    {
      title: "Corporate",
      links: [
        { label: "About ScoutForge AI", href: "#" },
        ...
        <div className="grid lg:grid-cols-4 gap-12 mb-32 border-b border-[#F0F0F3] dark:border-white/5 pb-24">
          <div className="lg:col-span-2 space-y-10">
            ...
            <p className="text-lg text-[#6E6E73] dark:text-[#86868B] font-medium max-w-lg leading-relaxed">
              ScoutForge AI delivers sub-second competitive intelligence through a global mesh of autonomous agents. Deciphering signals, ensuring market dominance.
            </p>
