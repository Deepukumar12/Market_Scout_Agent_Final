...
const InsightPanel: React.FC<InsightPanelProps> = ({ insight, focusAreas }) => {
  return (
    <motion.div
      ...
      className="p-8 rounded-[40px] bg-foreground text-white shadow-apple relative overflow-hidden h-full border border-white/10"
    >
      ...
      <div className="space-y-3 relative z-10">
        <p className="text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground">Priority Vectors</p>
